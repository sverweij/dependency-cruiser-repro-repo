...
module.exports = {
  forbidden: [
    ...
    /* rules you might want to tweak for your specific situation: */
    {
      ...
      from: {},
      to: {
        path: '\\.(unit|acceptance|e2e|integration)\\.(js|mjs|cjs|ts|ls|coffee|litcoffee|coffee\\.md)$'
      }
    },
    {
      name: 'not-to-dev-dep',
      ...
      from: {
        path: '^(src)',
        pathNot: '(unit|acceptance|e2e|integration|fake\-pim)\\.(js|mjs|cjs|ts|ls|coffee|litcoffee|coffee\\.md)$'
      },
      to: {
        dependencyTypes: [
          'npm-dev'
...
// generated: dependency-cruiser@11.11.0 on 2022-07-04T21:54:27.110Z
