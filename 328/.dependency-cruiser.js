module.exports = {
  required: [
    {
      name: "controllers-must-inherit-from-base",
      comment:
        "Every controller is expected to inherit from the base controller",
      severity: "warn",
      module: {
        ...
        */
        theme: {
          ...
          modules: [
            ...
            {
              criteria: { source: "base-controller\\.ts$" },
          ...
          dependencies: [
            ...
            {
              criteria: { resolved: "base-controller\\.ts$" },
              attributes: { color: "#ff00ff77" },
            },
            {
              criteria: { resolved: "^src/controllers" },
...
// generated: dependency-cruiser@9.8.0 on 2020-07-04T07:23:55.955Z
